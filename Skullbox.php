    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="product-images">
          ...
          <div class="main-image mb-3">
            <img id="mainImage" src="images/Skullbox.jpeg" alt="Main Product Image" class="img-fluid rounded">
          </div>

          <!-- Thumbnail Images -->
          <div class="thumbnail-images">
            <img src="images/Skullbox.jpeg" alt="Thumbnail 1" onclick="changeMainImage(this)">
            <img src="images/sb1.webp" alt="Thumbnail 2" onclick="changeMainImage(this)">
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="product-details">
          <h1 class="product-title">Skullbox (Switch)</h1>
          ...
          Our convex button-caps are designed for performance and comfort. Inspired by the classic Japanese Sanwa pushbuttons, all our button caps are made by injection-moulded ABS. These are not 3D printed parts.
          </p>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="product-full-description">
          ...
          <p>
          Our case is machined from a solid piece of ABS for maximum heft and durability. We do not 3D print our cases.
Features a super low profile dimension: 24cm x 15.5cm x 1.2cm
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        <div class="product-specifications">
          ...
          <ul>
            ...
            <li><strong>Artwork Customization:</strong> Hotswappable</li>
            <li><strong>Carry Case:</strong> None</li>
            <li><strong>Dimensions (Approximate):</strong> 24cm x 15.5cm x 1.2cm</li>
            <li><strong>Approximate Weight:</strong> 300 g</li>
            <li><strong>Box Contents:</strong> Skullbox / 10.1 ft wired USB Type C to USB Type A cable, Important Product Information Guide</li>
          </ul>
        </div>
      </div>
    </div>
