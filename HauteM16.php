    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="product-images">
          ...
          <div class="main-image mb-3">
            <img id="mainImage" src="images/HauteM16nb.png" alt="Main Product Image" class="img-fluid rounded">
          </div>

          <!-- Thumbnail Images -->
          <div class="thumbnail-images">
            <img src="images/HauteM16nb.png" alt="Thumbnail 1" onclick="changeMainImage(this)">
            <img src="images/m161.jpg" alt="Thumbnail 2" onclick="changeMainImage(this)">
            <img src="images/m162.jpg" alt="Thumbnail 3" onclick="changeMainImage(this)">
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6">
        <div class="product-details">
          <h1 class="product-title">Haute M16 (Switc)</h1>
          ...
          Ultra Low Latency & Supports firmware updates:Haute42 leverless controller adopts Raspberry Pi RP2024 controller chip with firmware GP2040-CE, 1ms latency, no leakage of more than 95% of the frames, support firmware update(Strong technical support team)
          </p>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="product-full-description">
          ...
          <p>
          Larger Aluminum Panels & Ergonomic: Leverless controller M16 plus is CNC machined from aluminum alloy,it's amazingly stylish and nice.The size is 300*200*12.5 mm, it fits well on the knee,more ergonomic,brings more comfortable gaming operation experience
          </p>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        <div class="product-specifications">
          ...
          <ul>
            ...
            <li><strong>Mechanical Action Buttons:</strong>Kailh Switches</li>
            ...
            <li><strong>Artwork Customization:</strong> Hotswappable buttons</li>
            <li><strong>Carry Case:</strong> None</li>
            <li><strong>Dimensions (Approximate):</strong>  300*200*12.5 mm</li>
            <li><strong>Approximate Weight:</strong> 300 g</li>
            <li><strong>Box Contents:</strong> Haute M16 / 10.1 ft wired USB Type C to USB Type A cable, Important Product Information Guide</li>
          </ul>
        </div>
      </div>
    </div>
