...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 17, 2024 at 03:57 AM
...
CREATE TABLE `payments` (
  ...
  `order_id` int(11) NOT NULL,
  `payment_method` enum('Gcash','PayPal','CreditCard') NOT NULL,
...
(7, 'user', '$2y$10$XnPLK94XnBkW1A9w5uaLmuvBNOIZA3nM7CRhRGAJ1YLsk8XIHathO', 'user@gmail.com', 'Customer');
...
--
ALTER TABLE `customizations`
  ADD CONSTRAINT `customizations_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`product_id`) ON DELETE CASCADE;
